...
namespace TimePicker
{
...

    {
        ...
        public static readonly DependencyProperty HoursProperty =
            DependencyProperty.Register("Hours", typeof(int), typeof(Picker),
        ...
        public static readonly DependencyProperty MinutesProperty =
            DependencyProperty.Register("Minutes", typeof(int), typeof(Picker),
                new UIPropertyMetadata(0, new PropertyChangedCallback(OnTimeChanged)));
        ...
        public static readonly DependencyProperty SecondsProperty =
            DependencyProperty.Register("Seconds", typeof(int), typeof(Picker),
                new UIPropertyMetadata(0, new PropertyChangedCallback(OnTimeChanged)));
